  ...
  const data = {
    ...
    l_paras_data: {
      ...
      paragraph1: {
        ...
        body: (
          <>
            {name}은/는 {deathMonthDay} 세상을 떠났습니다.
            <br />
            {name}의 죽음을 추모하는 사람들이 그의 묘비 앞에서 {name}을 추억합니다. {alias} 사람 {name}은/는 {lastWord} 라는 한마디를 남겼습니다.
          </>
        ),
      },
      paragraph2: {
      ...
      paragraph3: {
        ...
        body: (
          <>
            {name}은/는 {happyMoment}에 행복함을 만끽했습니다.
            <br />그 순간, {name}은/는 세상 누구보다도 행복한 사람이라고 느꼈습니다.
          </>
        ),
      },
    },
